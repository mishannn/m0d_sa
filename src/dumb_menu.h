...
#define MENU_COLOR_SEPARATOR	D3DCOLOR_XRGB( 255, 0, 0 )
#define MENU_HUD_SELECT			D3DCOLOR_XRGB( 127, 127, 127 )
#define MENU_ITEM_SELECT		D3DCOLOR_XRGB( 255, 165, 20 )
#define MENU_TB_BACKGROUND		D3DCOLOR_ARGB( 190, 20, 20, 20 )
#define MENU_COLOR_BACKGROUND	D3DCOLOR_ARGB( 190, 20, 20, 20 )
