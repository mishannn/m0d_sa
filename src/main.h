...
#define M0D_VERSION		"4.3.3.4-21.06.15 от FYP, модифицированный MishaN для Cheat-Master.Ru"
#define SAMP_VERSION	"SAMP 0.3.7"
...
#define __CHEAT_VEHRECORDING_H__ 1
...
#include "raknet\SAMP\samp_rpc.h"
